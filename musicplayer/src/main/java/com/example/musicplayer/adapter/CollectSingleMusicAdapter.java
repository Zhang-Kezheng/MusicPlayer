 ...
 */
public class CollectSingleMusicAdapter extends BaseAdapter {
    private int index=-1;
    private final LayoutInflater inflater;
    private final List<MusicInfo> data;

    public CollectSingleMusicAdapter(Context context, MusicPlayerApplication application) {
        this.data=application.appSet.getCollect();
